...
#+BEGIN_SRC jupyter-julia
  ...
  nbatch = 32
  nepochs = 10
  model_dir = "tmpxj82Qn" # mktempdir(abspath(""))
  frac_test = .3
...
:RESULTS:
# Out[8]:
: PyObject <function model_fn at 0x7fc61402d510>
:END:
...
:RESULTS:
# Out[10]:
: PyObject <function input_wrapper_function.<locals>._input_fn at 0x7fc567f81bf8>
:END:
